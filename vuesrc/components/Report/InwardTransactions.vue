    ...
    <div class="card-body">
      <form class="inward-transactions-report-form">
        ...
        <div class="mt-4" v-if="isLoading == 0 && transactions.length > 0">
          <div class="row">
            <div class="col">
              <h1>INWARD TRANSACTIONS - {{ date }}</h1>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
          ...
          <div class="accordion mt-2" id="reportInwardTransactionAccordion">
            <div
              class="card mb-0"
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 text-right pr-5">
                    <h3 class="mb-0 text-white">
                      {{
                        (transaction.flowStatus == 3 ? transaction.status : "")
                      }}
                    </h3>
                  </div>
                </div>
          ...
          vm.$store
            ...
            .then((res) => {
              ...
              if (res instanceof Blob) {
                saveAs(res, `Inward Report (${reportDate}).xlsx`);
                this.close();
              } else
                this.$popover({
                  icon: "fas fa-exclamation-triangle",
